      ...
      <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
        <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
          ...
          <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8 mr-5">
            <a href="#" className="font-medium text-gray-500 hover:text-gray-900">Professionals</a>

            <a href="#" className="font-medium text-gray-500 hover:text-gray-900">Opportunities</a>
          </div>
        </nav>
      </div>
